...
public class CustomSMTPAppender extends AppenderSkeleton implements UnrecognizedElementHandler {
	private String to;
	private String cc;
	private String bcc;
	private String from;
	...
	public CustomSMTPAppender(TriggeringEventEvaluator evaluator) {
		this.evaluator = evaluator;
	}
	...
	protected String formatBody() {
		...
		if (!(layout instanceof PatternLayout || layout instanceof HTMLLayout)) {
			layout = htmlLayout;
		}
